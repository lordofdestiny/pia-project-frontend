...
export class DoctorProfileComponent implements OnInit, AfterViewInit, OnDestroy {
    styles = {
        "font-size": "0.8rem",
    };
    user?: Doctor;
    ...
    specialzations: Specialization[] = this.route.snapshot.data["specializations"];
    constructor(
    ...
    handleExaminationsSave(examinations: Examination[]) {
        ...
        return this.doctorsService.update_examinations(this.userId, examinationIds).subscribe({
            next: (result) => {
